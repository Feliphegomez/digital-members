...
namespace FelipheGomez\PhpCrudApi\Controller {
    ...
    class RecordController
    {
        ...
        public function __construct(Router $router, Responder $responder, RecordService $service)
        {
            ...
            $router->register('POST', '/records/*/*', array($this, 'update'));
            $router->register('GET', '/records/*/*/delete', array($this, 'delete'));
...
namespace FelipheGomez\PhpCrudApi\Record {
    ...
    class ErrorCode
    {
        ...
        private $values = [
            ...
            1010 => ["Infracción de integridad de datos", ResponseFactory::CONFLICT],
            1011 => ["Autenticacion requerida", ResponseFactory::UNAUTHORIZED],
            ...
            1016 => ["Temporal o permanentemente bloqueada", ResponseFactory::FORBIDDEN],
    ...
    class RelationJoiner
    {
        ...
        private function getJoinsAsPathTree(array $params): PathTree
        {
            ...
            if (isset($params['join'])) {
                foreach ($params['join'] as $tableNames) {
					$tableNames = is_array($tableNames) ? implode(", ", $tableNames) : $tableNames;
                    $path = array();
                    foreach (explode(',', $tableNames) as $tableName) {
