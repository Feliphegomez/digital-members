...
function dmrfid_add_pages() {
	...
	// Top level menu
	add_menu_page( __( 'Memberships', 'digital-members-rfid' ), __( 'Memberships', 'digital-members-rfid' ), 'dmrfid_memberships_menu', 'dmrfid-dashboard', $top_menu_cap, 'dashicons-groups', 30 );
