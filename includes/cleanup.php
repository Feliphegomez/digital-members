	...
	if ( ! empty( $userids_have_levels ) ) { ?>
		<div class="notice notice-error inline">
			<?php if ( count( $userids ) > 1 ) {
				_e( '<p><strong> Advertencia: </strong> uno o más usuarios para eliminar tienen un nivel de membresía activo. Eliminar un usuario también cancelará su membresía y suscripción recurrente.</p>', 'digital-members-rfid' );
			} else {
				_e( '<p><strong> Advertencia: </strong> este usuario tiene un nivel de membresía activo. Eliminar un usuario también cancelará su membresía y suscripción recurrente.</p>', 'digital-members-rfid' );
			}
		?>
		</div>
	<?php
