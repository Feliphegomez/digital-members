...
Contributors: strangerstudios, kimannwall, andrewza, dlparker1005, paidmembershipspro, feliphegomez
Tags: memberships, members, subscriptions, ecommerce, user registration, member, membership, e-commerce, paypal, stripe, braintree, authorize.net, payflow, restrict access, restrict content, directory
Requires at least: 4
Tested up to: 5.5
Stable tag: 2.5

Get Paid with Digital Members RFID: The most complete member management and membership subscriptions plugin for your WordPress site.

== Description ==

= The most complete member management and membership subscriptions plugin for WordPress =

Digital Members RFID gives you all the tools you need to start, manage, and grow your membership site. The plugin is designed for premium content sites, clubs/associations, subscription products, newsletters and more.
...
1. Go to Plugins > Add New to find and install Digital Members RFID.
...
* ENHANCEMENT: Added to code to stop network activation of Digital Members RFID. (Thanks, Paul Barthmaier)
