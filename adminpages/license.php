		...
		<div class="about-text">
			...
			<p>
				<?php if ( ! dmrfid_license_isValid() ) { ?>
					<a class="button button-primary button-hero" href="https://www.managertechnology.com.co/membership-checkout/?level=20&utm_source=plugin&utm_medium=dmrfid-license&utm_campaign=plus-checkout&utm_content=buy-plus" target="_blank"><?php echo esc_html( 'Buy Plus License', 'digital-members-rfid' ); ?></a>
					<a class="button button-hero" href="https://www.managertechnology.com.co/pricing/?utm_source=plugin&utm_medium=dmrfid-license&utm_campaign=pricing&utm_content=view-license-options" target="_blank"><?php echo esc_html( 'View Support License Options', 'digital-members-rfid' ); ?></a>
				<?php } else { ?>
					...
					<a class="button button-hero" href="https://www.managertechnology.com.co/login/?redirect_to=%2Fnew-topic%2F%3Futm_source%3Dplugin%26utm_medium%3Ddmrfid-license%26utm_campaign%3Dsupport%26utm_content%3Dnew-support-ticket" target="_blank"><?php echo esc_html( 'Open Support Ticket', 'digital-members-rfid' ); ?></a>
				<?php } ?>
			</p>
			...
			<p><a href="https://www.managertechnology.com.co/pricing/?utm_source=plugin&utm_medium=dmrfid-license&utm_campaign=pricing&utm_content=view-license-options" target="_blank"><?php echo esc_html( 'View Support License Options &raquo;', 'digital-members-rfid' ); ?></a></p>
