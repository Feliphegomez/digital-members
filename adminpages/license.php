		...
		<div class="about-text">
			...
			<table class="form-table">
				<tbody>
					<tr id="dmrfid-settings-key-box">
						<td>
							<input type="password" name="dmrfid-license-key" id="dmrfid-license-key" value="<?php echo esc_attr($key);?>" placeholder="<?php _e('Enter license key here...', 'paid-memberships-pro' );?>" size="40"  />
							<?php wp_nonce_field( 'dmrfid-key-nonce', 'dmrfid-key-nonce' ); ?>
							<?php submit_button( __( 'Validate Key', 'paid-memberships-pro' ), 'primary', 'dmrfid-verify-submit', false ); ?>
						</td>
					</tr>
				</tbody>
			</table>
			...
			<p>
				<?php if ( ! dmrfid_license_isValid() ) { ?>
					<a class="button button-primary button-hero" href="https://www.paidmembershipspro.com/membership-checkout/?level=20&utm_source=plugin&utm_medium=dmrfid-license&utm_campaign=plus-checkout&utm_content=buy-plus" target="_blank"><?php echo esc_html( 'Buy Plus License', 'paid-memberships-pro' ); ?></a>
					<a class="button button-hero" href="https://www.paidmembershipspro.com/pricing/?utm_source=plugin&utm_medium=dmrfid-license&utm_campaign=pricing&utm_content=view-license-options" target="_blank"><?php echo esc_html( 'View Support License Options', 'paid-memberships-pro' ); ?></a>
				<?php } else { ?>
					...
					<a class="button button-hero" href="https://www.paidmembershipspro.com/login/?redirect_to=%2Fnew-topic%2F%3Futm_source%3Dplugin%26utm_medium%3Ddmrfid-license%26utm_campaign%3Dsupport%26utm_content%3Dnew-support-ticket" target="_blank"><?php echo esc_html( 'Open Support Ticket', 'paid-memberships-pro' ); ?></a>
				<?php } ?>
			</p>
			...
			<img class="dmrfid_icon alignright" src="<?php echo DMRFID_URL?>/images/Paid-Memberships-Pro_icon.png" border="0" alt="Digital Members RFID(c) - All Rights Reserved" />
			<?php
			...
			<?php
				echo '<p>' . sprintf( wp_kses( __( 'Digital Members RFID and our Add Ons are distributed under the <a href="%s" title="GPLv2 license" target="_blank">GPLv2 license</a>. This means, among other things, that you may use the software on this site or any other site free of charge.', 'paid-memberships-pro' ), $allowed_dmrfid_license_strings_html ), 'https://www.paidmembershipspro.com/features/paid-memberships-pro-is-100-gpl/?utm_source=plugin&utm_medium=dmrfid-license&utm_campaign=documentation&utm_content=gpl' ) . '</p>';
			?>
			...
			<p><a href="https://www.paidmembershipspro.com/pricing/?utm_source=plugin&utm_medium=dmrfid-license&utm_campaign=pricing&utm_content=view-license-options" target="_blank"><?php echo esc_html( 'View Support License Options &raquo;', 'paid-memberships-pro' ); ?></a></p>
